# Copilot Agent Instructions for `docx-to-md`

## Scope
Use this file when working as GitHub Copilot (or similar assistants) in this repository.

This is the Copilot-side instruction file. The Codex-side mirror lives at:
- `AGENTS.md`

Both files should stay aligned on major project facts.

## Sync Policy With `AGENTS.md` (Important)
Treat `.github/copilot-instructions.md` and `AGENTS.md` as mirrored guidance.
...
1. Update `AGENTS.md` in the same branch.
